...
static const VentureCard VENTURE_CARD_TABLE[128] = {
    ...
    { true  , true  , "Venture through space! Pay 100G to zoom straight to the bank!"                                                    },
    ...
    { false , false , "Venture on! Roll the special all-7s-and-8s die and move forward again."                                           },
    ...
    { false , false , "Misadventure! All other players can only move forward 7 on their next turn."                                      },
    ...
    { true  , false , "Lucky venture! You get a really big commission until your next turn!"                                             },
