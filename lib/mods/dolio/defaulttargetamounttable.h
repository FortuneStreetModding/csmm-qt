#ifndef DEFAULTTARGETAMOUNTTABLE_H
#define DEFAULTTARGETAMOUNTTABLE_H

#include "doliotable.h"

class DefaultTargetAmountTable : public virtual DolIOTable
{
public:
    static constexpr std::string_view MODID = "defaultTargetAmountTable";
...
#endif // DEFAULTTARGETAMOUNTTABLE_H
