...
inline QString gameBoardCmpres(const QString &locale) {
    if (locale == "jp") {
        return "files/game/game_board.cmpres";
    }
    return QString("files/game/lang%1/game_board_%1.cmpres").arg(localeToUpper(locale));
}
