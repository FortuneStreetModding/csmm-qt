...
quint32 TourOpponentsTable::writeTable(const QVector<MapDescriptor> &descriptors) {
...
void TourOpponentsTable::readAsm(QDataStream &stream, QVector<MapDescriptor> &mapDescriptors, const AddressMapper &, bool isVanilla) {
    if (isVanilla) {
